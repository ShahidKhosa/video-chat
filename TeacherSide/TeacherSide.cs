...
namespace Video_Conference
{
	...
	public class TeacherSide : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.btnStartLecture.Location = new System.Drawing.Point(1, 75);
            ...
            this.btnStartLecture.Text = "Start Call";
            ...
            this.lstBoxStudents.Location = new System.Drawing.Point(545, 259);
            this.lstBoxStudents.Name = "lstBoxStudents";
            this.lstBoxStudents.ScrollAlwaysVisible = true;
            this.lstBoxStudents.Size = new System.Drawing.Size(170, 304);
            ...
            this.label1.Location = new System.Drawing.Point(547, 238);
            ...
            this.lblTeacherName.Size = new System.Drawing.Size(0, 18);
            ...
            this.picBoxQuestionVideo.Image = global::Video_Conference.Properties.Resources.uni_logo;
            this.picBoxQuestionVideo.Location = new System.Drawing.Point(102, 75);
            this.picBoxQuestionVideo.Name = "picBoxQuestionVideo";
            this.picBoxQuestionVideo.Size = new System.Drawing.Size(436, 358);
            this.picBoxQuestionVideo.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
            this.picBoxQuestionVideo.TabIndex = 6;
            ...
            this.picBoxTeacher.Image = global::Video_Conference.Properties.Resources.uni_logo1;
            this.picBoxTeacher.Location = new System.Drawing.Point(544, 75);
            this.picBoxTeacher.Name = "picBoxTeacher";
            this.picBoxTeacher.Size = new System.Drawing.Size(170, 135);
            this.picBoxTeacher.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
            this.picBoxTeacher.TabIndex = 12;
            this.picBoxTeacher.TabStop = false;
            this.picBoxTeacher.Click += new System.EventHandler(this.picBoxTeacher_Click);
            // 
            // TeacherSide
            // 
        ...
        {
            if (btnStartLecture.Text.Equals("Start Call"))
            {
                
                               
                if (lstBoxStudents.Items.Count > 0)
                {
                    btnStartLecture.Text = "End Call";
                    hd = hHwnd;
                    StartSendingAudio();
                    timer1.Enabled = true;
                ...
                {
                    MessageBox.Show("No user is online at this time!", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
            }
            else
            {
               ...
               // btnAccept.Text = "Accept";
                picBoxQuestionVideo.Image = Image.FromFile("uni_logo.jpg");
                /*
                ...
                ClosePreviewWindow();
                StopAudio();
                picBoxTeacher.Image = Image.FromFile("uni_logo.jpg");
                lstBoxStudents.Items.Clear();
               // btnTestAVDevices.Enabled = true;
                btnStartLecture.Text = "Start Call";                
            }
        }
            ...
            else
            {
                switch (message.cmd)
                {
                    case Command.Leave:
                        ...
                        if (picBoxQuestionVideo.Visible && questioningStudentName != null && questioningStudentName.Equals(message.senderName))
                        {
                            picBoxQuestionVideo.Visible = false;
                            tmrStudentVideo.Enabled = false;
                        }
                    ...
                    case Command.QuestionRequest:
                       // lstBoxQuestionRequests.Items.Add(message.senderName);
                        ...
                        if (MessageBox.Show(message.senderName + " is calling", "User Call", MessageBoxButtons.OKCancel, MessageBoxIcon.Information) == DialogResult.OK)
                        {
                            object val = null;
                            foreach (DictionaryEntry item in studentList)
                            {
                                if (item.Key.Equals(lstBoxStudents.Items[0]))
                                {
                                    val = item.Value;
                                    break;
                                }
        ...
        {
            if (MessageBox.Show("Are you sure to leave the class room", "Leave confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                timer1.Enabled = false;
                Data data = new Data();
        ...
        private void picBoxTeacher_Click(object sender, EventArgs e)
        {
